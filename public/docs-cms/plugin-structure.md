...
```php
{
    ...
    "provider": "Platform\\Demo\\Providers\\DemoServiceProvider",
    "author": "Sang Nguyen",
...
use Schema;
use Platform\Base\Interfaces\PluginInterface;
...
```php
Route::group(['namespace' => 'Platform\Demo\Http\Controllers', 'middleware' => 'web'], function () {
