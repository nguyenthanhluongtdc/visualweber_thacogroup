...
\Event::listen(\Platform\Theme\Events\RenderingSingleEvent::class, function (\Platform\Theme\Events\RenderingSingleEvent $event) {
    if ($event->slug->reference_type == \Platform\Blog\Models\Post::class) {
