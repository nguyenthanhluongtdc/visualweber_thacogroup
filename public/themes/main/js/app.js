...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadGallery: function loadGallery(id) {
      var _this = this;

      this.$http.get('api/get/gallery/post/' + id).then(function (response) {
        return response.data.data;
      }).then(function (response) {
        _this.galleryImage = response;

        _this.showModalAlbumImage();
    ...
    [
      _c("div", { staticClass: "media-content" }, [
        ...
        _c("div", { staticClass: "media-wrapper" }, [
          _c("div", { staticClass: "container-customize" }, [
            _vm._m(1),
            _vm._v(" "),
                        ...
                        _c(
                          ...
                          _vm._l(_vm.dataImage.data, function(item) {
                            return _c("div", { staticClass: "image-item" }, [
                              _c("div", { staticClass: "image-item__img" }, [
                                _c("img", {
                                  attrs: {
                                    src: "storage/" + item.image,
                                    alt: ""
                              ...
                              _c(
                                "div",
                                { staticClass: "image-item__download" },
                                [
                                  _c(
                                    "a",
                                    {
      ...
      _c("modal", { attrs: { name: "my-first-modal" } }, [
        _c("div", { staticClass: "modal-main p-4" }, [
          _c("div", { staticClass: "modal-header-custom" }, [
            ...
            _c(
              "h2",
              { staticClass: "name font28 text-center mb-4 font-weight-bold" },
              [
                _vm._v(
              ...
              _c(
                ...
                [
                  _c(
                    ...
                    _vm._l(_vm.galleryImage, function(item) {
                      return _c("div", { staticClass: "col-lg-4 p-2" }, [
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "image-item__back" }, [
      _c("i", { staticClass: "far fa-image" }),
      _vm._v(" "),
      _c("p", { staticClass: "text font18" }, [_vm._v("Album")])
    ])
  }
]
...
vue__WEBPACK_IMPORTED_MODULE_4__["default"].use((vue_js_modal__WEBPACK_IMPORTED_MODULE_3___default()));
vue__WEBPACK_IMPORTED_MODULE_4__["default"].prototype.$http = (axios__WEBPACK_IMPORTED_MODULE_2___default());
vue__WEBPACK_IMPORTED_MODULE_4__["default"].component('page-media', _pages_Media__WEBPACK_IMPORTED_MODULE_0__["default"]);
vue__WEBPACK_IMPORTED_MODULE_4__["default"].mixin(Object(function webpackMissingModule() { var e = new Error("Cannot find module './common'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
