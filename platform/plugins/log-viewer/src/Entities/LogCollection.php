...
namespace Platform\LogViewer\Entities;

use Platform\LogViewer\Contracts\Utilities\Filesystem as FilesystemContract;
use Platform\LogViewer\Contracts\Utilities\Filesystem;
use Platform\LogViewer\Exceptions\LogNotFoundException;
