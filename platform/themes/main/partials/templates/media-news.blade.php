    ...
    <div class="list-info">  
        ...
        <div class="report-item">
            ...
            <div class="report-item-right">
                ...
                <a href="{{ has_field($item, 'repeater_file_media') ? get_object_image(has_sub_field(has_field($item, 'repeater_file_media')[0], 'file')) : '#'}}" target="_blank"><p class="name-file font18 ">{{str::words($item->name,20)}} </p></a>
