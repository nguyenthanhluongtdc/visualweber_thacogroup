@forelse($data as $item)
    <div class="report-item" data-aos="fade-up" data-aos-duration="600" data-aos-delay="50"
        ...
        <div class="report-item-right">
            ...
            <a href="{{ get_object_image(has_sub_field(has_field($item, 'repeater_file_post_investor')[0], 'file')) }}"
                target="_blank">
            ...
            <div class="download">
                <a download
                    href="{{ get_object_image(has_sub_field(has_field($item, 'repeater_file_post_investor')[0], 'file')) }}"
