                                    ...
                                    <div class="post_content_bottom h-100">
                                        <a class="post-wrapper" href=" {{ $post_bottom->url }}">
                                            <div class="post-thumbnail">
                                                <img src="{{ Storage::disk('public')->exists(get_object_image($post_bottom->image)) ? get_image_url(get_object_image($post_bottom->image)) : RvMedia::getDefaultImage()}}" alt="">
                                            </div>
                    ...
                    @foreach ($posts as $post)
                        <div class="media-item ">
                            <div class="img-content">
                                <div class="image">
                                    <div class="post-thumbnail">
                                        <a href="{{ $post->url }}"><img src="{{ Storage::disk('public')->exists(get_object_image($post->image)) ? get_image_url(get_object_image($post->image)) : RvMedia::getDefaultImage()}}"
                                                alt=""></a>
                                    </div>
                                </div>
                                <div class="content">
