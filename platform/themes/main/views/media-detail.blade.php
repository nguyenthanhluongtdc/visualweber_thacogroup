...
<div class="post-detail-wrapper">
    <div class="post-detail-content">
        <div class="poster-left order-1" data-aos="flip-up" data-aos-duration="400" data-aos-delay="50" class="aos-init aos-animate">
            <img src="{{ Theme::asset()->url('images/media/post-poster.jpg') }}" alt="">
        </div>
        <div class="poster-right order-3" data-aos="flip-up" data-aos-duration="400" data-aos-delay="50" class="aos-init aos-animate">
            <img src="{{ Theme::asset()->url('images/media/post-poster.jpg') }}" alt="">
        </div>
        <div class="content-middle order-2 " data-aos="fade-up" data-aos-duration="700" data-aos-delay="50" class="aos-init aos-animate">
            ...
            <div class="post-related mt-40 mb-60">
                <div class="post-related__title" data-aos="fade-right" data-aos-duration="700" data-aos-delay="50" class="aos-init aos-animate">
                    <img src="{{ Theme::asset()->url('images/media/icon-title.png') }}" alt="">
                    <h2  class="font30 big-title">CÁC BÀI VIẾT LIÊN QUAN</h2>
                </div>
                <ul class="list-post-related" data-aos="zoom-in-up" data-aos-duration="400" data-aos-delay="50" class="aos-init aos-animate">
                    <li class="font18">
                        <a href="">
