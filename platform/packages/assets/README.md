...
[![Build Status](https://img.shields.io/travis/vswb/laravel-assets/master.svg?style=flat-square)](https://travis-ci.org/vswb/laravel-assets)
...
```bash
composer require platform/assets
```
...
'providers' => [
    ...
    Platform\Assets\Providers\AssetsServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'Assets' => Platform\Assets\Facades\AssetsFacade::class,
];
```
...
```bash
php artisan vendor:publish --provider="Platform\Assets\Providers\AssetsServiceProvider" --tag=config
```
